...
from .ext.training import train_logreg_vanilla
...
def check_processing_loss(
    ...
    if model_type == "logreg":
        from .ext.training import train_logreg_vanilla as train_model
    elif model_type == "xgb":
        from .ext.training import train_xgb as train_model
    elif model_type == "rf":
        from .ext.training import train_rf as train_model
    elif model_type == "dnn":
